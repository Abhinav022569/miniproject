document.addEventListener('DOMContentLoaded', () => {
    ...
    // The 'currentUserId' variable is now available globally from the script tag in group_chat.php

    // Function to fetch and display messages
    const fetchMessages = async (groupId) => {
        try {
            // Path to fetch script is now relative to the PHP file's location
