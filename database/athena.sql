...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 19, 2025 at 01:32 PM
...
(1, 'admin', 'adminpass', 'admin@athena.com');
...
(1, 1, 1, '2025-07-19 16:50:13'),
(2, 2, 1, '2025-07-19 15:50:13'),
(3, 3, 1, '2025-07-19 14:50:13');
...
(1, 1, 2, 'Calculus II - Integrals', '/notes/calc_integrals.pdf', '2025-07-19 14:50:13'),
(2, 2, 3, 'Art History - Renaissance', '/notes/art_renaissance.docx', '2025-07-18 16:50:13'),
(3, 3, 4, 'Physics - Kinematics', '/notes/physics_kinematics.txt', '2025-07-16 16:50:13');
...
INSERT INTO `study_group` (`group_id`, `group_name`, `user_id`, `approved`, `created_at`) VALUES
(1, 'Calculus II Study', 1, 1, '2025-07-19 16:50:13'),
(2, 'History of Art', 1, 1, '2025-07-19 16:50:13'),
(3, 'Physics 101', 1, 1, '2025-07-19 16:50:13');
...
INSERT INTO `to_do` (`to_do_id`, `group_id`, `user_id`, `task`, `due_date`, `assigned_to`, `status`) VALUES
(1, 1, 1, 'Review Chapter 5 Notes', '2025-07-20', 1, 'Open'),
(2, 2, 1, 'Prepare for Group Meeting', '2025-07-23', 1, 'Open'),
(3, 3, 1, 'Upload Physics Homework', '2025-07-26', 1, 'Open');
...
INSERT INTO `users` (`user_id`, `user_name`, `name`, `email`, `phone_no`, `password`, `status`, `reputation_score`, `created_at`) VALUES
(1, 'alex_student', 'Alex Smith', 'alex@example.com', '1112223330', 'alexpass', 'active', 150, '2025-07-19 16:50:12'),
(2, 'sarah_notes', 'Sarah Johnson', 'sarah@example.com', '4445556660', 'sarahpass', 'active', 250, '2025-07-19 16:50:12'),
(3, 'john_learner', 'John Doe', 'john@example.com', '7778889990', 'johnpass', 'active', 120, '2025-07-19 16:50:12'),
(4, 'emily_reader', 'Emily White', 'emily@example.com', '1012023030', 'emilypass', 'active', 180, '2025-07-19 16:50:12');
